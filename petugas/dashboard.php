...
<head>
  ...
  <title>Dashboard Petugas - SevenLibrary v6</title>
  <!-- Tailwind CSS -->
          ...
          <div class="flex items-center">
            <div class="dropdown relative ml-3">
              <button class="flex items-center text-sm rounded-full focus:outline-none" id="user-menu-button">
                ...
                <span class="ml-2 hidden md:block">Petugas</span>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-r from-primary to-secondary rounded-xl p-6 text-white mb-6" data-aos="fade-up">
          <div class="flex flex-col md:flex-row justify-between items-center">
            <div>
              <h1 class="text-2xl font-bold">Selamat Datang, Petugas!</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div class="dashboard-card bg-white dark:bg-gray-800 p-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="mt-4">
              <a href="manage_books.php" class="text-sm text-primary dark:text-blue-400 hover:underline flex items-center">
                Kelola Buku
          ...
          <div class="dashboard-card bg-white dark:bg-gray-800 p-6" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="mt-4">
              <a href="manage_peminjaman.php" class="text-sm text-primary dark:text-blue-400 hover:underline flex items-center">
                Kelola Peminjaman
                <i class="lni lni-arrow-right ml-1"></i>
              </a>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2">
            <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white" data-aos="fade-up">Menu Utama</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a href="manage_peminjaman.php" class="menu-card dashboard-card bg-white dark:bg-gray-800 p-6 flex items-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <a href="manage_books.php" class="menu-card dashboard-card bg-white dark:bg-gray-800 p-6 flex items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <a href="manage_category.php" class="menu-card dashboard-card bg-white dark:bg-gray-800 p-6 flex items-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <a href="manage_users.php" class="menu-card dashboard-card bg-white dark:bg-gray-800 p-6 flex items-center" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="ml-4">
                  <h3 class="font-medium text-gray-900 dark:text-white">Kelola Akun</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Atur akun siswa perpustakaan</p>
                </div>
              </a>
            </div>
          ...
          <div class="lg:col-span-1">
            <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white" data-aos="fade-up">Aktivitas Terbaru</h2>
            <div class="dashboard-card bg-white dark:bg-gray-800 p-6" data-aos="fade-up" data-aos-delay="600">
              ...
              <?php else: ?>
                ...
                <div class="mt-6 text-center">
                  <a href="manage_peminjaman.php" class="text-sm text-primary dark:text-blue-400 hover:underline">
            ...
            <!-- Quick Actions -->
            <div class="dashboard-card bg-white dark:bg-gray-800 p-6 mt-6" data-aos="fade-up" data-aos-delay="700">
              <h3 class="font-medium text-gray-900 dark:text-white mb-4">Aksi Cepat</h3>
              <div class="space-y-3">
                <a href="verifikasi_return.php" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-500 dark:text-green-400">
                    <i class="lni lni-checkmark"></i>
                  </div>
                  <div class="ml-3">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">Verifikasi Pengembalian</p>
                  </div>
                </a>
                <a href="manage_books.php?action=add" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <div class="ml-3">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">Tambah Buku Baru</p>
                  </div>
                </a>
                <a href="manage_users.php?action=add" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <div class="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-purple-500 dark:text-purple-400">
                    <i class="lni lni-user"></i>
                  </div>
                  <div class="ml-3">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">Tambah Siswa Baru</p>
                  </div>
                </a>
              </div>
            </div>
